    ...
    <>
      <main className="w-full lg:w-5/6 m-auto">
        <section className="py-10 px-5 flex flex-col gap-8 items-center">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl py-1">Lleva tu vida profesional al éxito</h1>
        ...
        <section className="py-10">
          ...
          <p className="text-2xl text-muted-foreground text-center">Las certificaciones permiten demostrar su habilidad para realizar tareas y funciones específicas a un alto nivel de rendimiento</p>
            ...
            {benefits.map((benefit => {
              return (
                <div className="py-8 px-5 w-full lg:w-1/4" key={benefit.id}>
                  <h3 className="text-2xl font-light text-center">{benefit.title}</h3>
        ...
        <section className="py-10 w-3/4">
          <h2 className="scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-3xl py-3">Casos de éxito</h2>
        </section>
        <section className="py-10 w-3/4">
          <h4 className="scroll-m-20 text-2xl font-bold tracking-normal lg:text-2xl py-3">La certificación más importante y flexible para todos los perfiles profesionales</h4>
          <p className="text-lg text-slate-600">Ya sea si eres un profesional en educación, un especialista en recursos humanos, o director general de tu organización, la certificación en … te ayudará a ... ¿Quieres saber de la certificación gratuita?</p>
        </section>
        <section className="py-10 w-3/4">
        ...
        <hr />
        <section className="py-10 w-3/4">
          <h1 className="text-3xl font-bold py-4">Inicia una evaluación diagnóstica</h1>
