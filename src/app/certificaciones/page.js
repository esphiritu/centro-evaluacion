                ...
                <div className="relative pl-8 md:pl-[6rem]">
                  ...
                  <div className="pl-8">
                    ...
                    <Link href="./" className="text-lg text-teal-600 hover:underline">
                      <span className="py-3 text-xl overflow-clip"> Más información
              ...
              <div className="group w-full flex flex-col md:flex-row items-center md:items-start mb-[2rem] bg-gray-50 dark:bg-slate-800 shadow-md rounded-2xl py-10">
                <div className="relative pl-8 md:pl-[6rem]">
                  ...
                  <div className="pl-8">
                    ...
                    <p className="text-xl mb-4">En la evaluación se recopilan los conocimientos, experiencia, habilidades y actitudes que la persona posee y que son necesarios para desempeñarse en la función.</p>
                    <Link href="./" className="text-lg text-teal-600 hover:underline">
                      <span className="py-3 text-xl"> Más información
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-right ml-1 inline"><path d="m6 17 5-5-5-5" /></svg>
                      </span>
          ...
          <div className="py-10">
            ...
            <Table className="mt-10 md:w-4/5 w-full mx-auto">
              ...
              <TableHeader className="text-lg font-bold">
                <TableRow className="">
                  <TableHead className="w-1/6 lg:w-1/5">Nombre</TableHead>
                  <TableHead className="w-3/6 lg:w-3/5">Estándar de competencia</TableHead>
                  <TableHead className="w-1/6 lg:w-1/5 text-right lg:text-left px-0"> </TableHead>
                </TableRow>
              </TableHeader>
                    ...
                    return (
                      <TableRow key={estandar.id} className="group/item">
                        ...
                        <TableCell className="text-right px-0 lg:px-2">
                          <Drawer>
                            <DrawerTrigger className="group/details invisible group-hover/item:visible text-teal-600 group-hover/item:text-teal-700 hover/item:bg-slate-200 pl-2 pr-0 lg:pl-4 lg:pr-2 lg:py-1 rounded-full z-10 transition-colors ease-in-out duration-300">Detalles
                              ...
                              <div className="w-full text-xl lg:w-1/2 mx-auto px-5 py-2">
                                ...
                                <div className="py-3">
                                  <Link className="group transition-all duration-300 ease-in-out text-center bg-teal-600 hover:bg-teal-700 px-6 py-3 rounded-sm text-white font-bold md:text-xl mt-1 md:mt-6" href="./proceso">
                                    <span className="">Certificarme</span>
                                  </Link>
