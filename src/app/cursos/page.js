...
export default function Cursos() {
    ...
    <main className="w-full pt-19">
      ...
      <p className="
        ...
        py-4 
        uppercase 
        tracking-wider">Oferta educativa</p>
        <h1 className="
          text-4xl 
          text-center 
          text-white 
        ...
        <p className="
              ...
              w-full 
              lg:w-2/3 
              mx-auto">Cursos de auto gestión completos</p>
      </section>
      <section className="
        flex-grow-0 
        bg-gray-50 
        dark:bg-gray-900">
          ...
          <div className="container w-full pb-10 mt-6">
            <h2 className="
              ...
              font-bold 
              tracking-normal 
              pb-4">Cursos destacados en la comunidad
            </h2>
            <p className="
              text-xl 
              text-center 
              ...
              w-full 
              lg:w-2/3 
              mx-auto">Obten los beneficios que te ayudarán a certificarte en múltiples estándares de competencia</p>
            <FeaturedCoursesCard />
            <div className="py-10">
              <p className="
                text-center 
              ...
              <h2 className="
                ...
                font-bold 
                tracking-normal 
                pb-4">Explora los cursos por categoría
              </h2>
              <p className="
                text-xl 
                text-center 
                ...
                w-full 
                lg:w-2/3 
                mx-auto">Encuentra los mejores cursos de tu sector e industria para maximizar tus habilidades y experiencia</p>
            </div>
          </div>
        </section>
        ...
        <h2 className="
          ...
          font-bold 
          tracking-normal 
          pb-4 mb-3 lg:mb-9">Cursos más populares
        </h2>
        <MostPopularCourses />
        </section>
        <section className="bg-slate-700 py-10 h-auto lg:h-[24rem]">
