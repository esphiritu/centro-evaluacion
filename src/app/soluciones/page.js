export default function Soluciones() {
    ...
    <main className=" container w-full">
      ...
      <h3>Mejore la eficiencia y la productividad con evaluaciones precisas</h3>

      <section>
        <h4 className="text-2xl">Solicite una cotización gratuita y obtenga más información sobre nuestros servicios</h4>
      </section>
