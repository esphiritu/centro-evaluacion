  ...
  return (
    (<DayPicker
      ...
      labels={{
        ...
        labelCaption: ({ date }) => format(date, "MMMM yyyy", { locale: es  }),
      }}
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-lg first-letter:uppercase font-normal",
...
function CalendarDayButton({
  ...
  return (
    (<Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-proyecta-500 data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square h-auto w-full min-w-(--cell-size) flex-col gap-1 font-normal leading-none data-[range-end=true]:rounded-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props} />)
