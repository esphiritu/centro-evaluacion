          ...
          case "alerta":
            return (
              <div className="relative w-fit mb-5 ml-6 mt-5">
                ...
                <p className="leading-snug text-slate-700 dark:text-slate-400 px-1 py-1">Quedan pocos lugares</p>
              </div>
            );
          case "cerrado":
            return (
