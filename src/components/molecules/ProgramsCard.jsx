    ...
    programs.map((program => (
      <div>
        <div className={`
          ...
          w-full
          drop-shadow-lg`} key={program.index}>
          <div className={`
              w-full 
              lg:w-1/2 
              text-left 
            ...
            <p className="
              ...
              mt-8
              mb-10 
              lg:mb-[1rem]">{program.ProgramDescription}</p>
            <p className="
              text-left
              text-gray-500
              text-xl
          ...
          <div className="w-full lg:w-2/5 overflow-hidden">
            <Image
              ...
              className={`
                ${program.flexRowDirection === "lg:flex-row-reverse" ? 
                  "lg:rounded-l-xl lg:rounded-r-none" : "lg:rounded-r-xl lg:rounded-l-none"} 
                ${program.flexColDirection === "flex-col-reverse" ? 
