        ...
        <div className={`
          ...
          <div className={`
            ...
            <div className="flex justify-between">
              <div className={`w-fit mb-5 mt-6 ${course.labelType === "recomendado" ? "bg-amber-300/70 dark:bg-amber-200" : "bg-green-300/70 dark:bg-green-200"} rounded-md`}>
